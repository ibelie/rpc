...
func injectJavascript(identName string, dir string, entities []*Entity, behaviors []*Behavior, symbol_s []string, symbol_b []string) {
...
`, strings.Join(requires, ""), strings.Join(symbol_b, ", "), strings.Join(symbol_s, `',
