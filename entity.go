...
func entityProxy(identName string, dir string, entities []*Entity) ([]string, []string) {
...
%s
`, ident[0], ident[1], strings.Join(symbol_c, ""), strings.Join(symbol_b, ", "), strings.Join(symbol_v, ""), entityRoutes(entities))), 0666)
...
func entitySymbols(symbols []string) ([]string, []string, []string, []string) {
	maxSymbol := 0
	...
	return symbolConst, symbolValue, symbolSorted, versionBytes
}
